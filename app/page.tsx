...
const basePath = '/cnno-1775719348516';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Our signature OG Rolls are carefully crafted with a perfect blend of traditional and modern techniques, resulting in a soft, fragrant, and irresistible treat that satisfies any sweet tooth. Made with the finest ingredients, these rolls are a must-try for anyone looking to experience the authentic taste of CNNO.', i: 'https://images.pexels.com/photos/9443532/pexels-photo-9443532.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'For those who love a hint of nutty flavor, our Pistachio Rolls are a game-changer. These rolls combine the richness of pistachios with our signature cinnamon swirl, creating a unique and delicious experience that will leave you wanting more.', i: 'https://images.pexels.com/photos/34503276/pexels-photo-34503276.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Indulge in the decadence of our Chocolate Rolls, where rich, velvety chocolate meets the warmth of our signature cinnamon. Perfect for chocolate lovers, these rolls are a delightful treat that will satisfy any craving.', i: 'https://images.pexels.com/photos/10338469/pexels-photo-10338469.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Baby Rolls', d: 'Our Baby Rolls are the perfect snack for anyone looking for a bite-sized treat. These smaller rolls are packed with the same flavor and quality as our larger rolls, making them an excellent option for those who want to try a little bit of everything.', i: 'https://images.pexels.com/photos/5507697/pexels-photo-5507697.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Party Box', d: 'Gather your friends and family and indulge in our Party Box, featuring a selection of our signature rolls. This is the perfect option for parties, gatherings, or any occasion where you want to share the warmth and comfort of CNNO with your loved ones.', i: 'https://images.pexels.com/photos/7966082/pexels-photo-7966082.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft and deliver high-quality, artisanal sweet rolls that bring warmth and comfort to our community, fostering a culture of togetherness and indulgence.</p>
                </div>
                <div className="space-y-2">
